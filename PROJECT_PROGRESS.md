...
5. **Текущ checkpoint — Content-complete/reality Stage 2 pass:** `content-inventory/` V1 е валидиран с 13 records; `Ресторант Бохеми` е owner-confirmed partial. Разширеният dining pass е записан в `POPITAI_LOM_DINING_VERIFICATION_PASS_20260916.md`: 20+ силни текущи/вероятно активни кандидата и още 8–10 research/conflict кандидата, без автоматично приемане на local index `27`. Трите officially verified records остават единствените eligible dining records; следва bounded identity/dedupe пакет (`Friends/Valentino`, `Дунавски вълни/При Маца`, `Чановете`, `NARODEN`, `Kastelo`, `Каприз/При Финци`), после direct official field verification. Няма runtime adapter, import, schema или production промяна преди отделно approval;
