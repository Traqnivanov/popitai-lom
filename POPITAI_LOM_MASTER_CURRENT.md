...
Първият екран не показва цялата taxonomy. Води с търсене `Каква услуга търсиш?`, няколко конкретни бързи задачи и девет ясни семейства. След owner consolidation verdict от **Work 2 · 11.09.2026** видимите discovery входове са 45:
...
4. **Транспорт, преместване и доставки** — товарен транспорт; хамали и преместване; доставки.
...
| Services taxonomy | 9 семейства и 45 видими discovery входа; старите 59 понятия се пазят като aliases/filters/cross-links без data migration | 59 понятия като 59 отделни видими подкатегории и потенциално 59 отделни icon cards |
