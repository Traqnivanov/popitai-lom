...
**Work 2 proposal, още без owner verdict:** да се допускат стилово еднакви `small/site` и `large/social` варианти само когато един SVG не запазва качеството и в двата размера. Те могат да бъдат приети единствено заедно след сравнение при 20–24 px, desktop card, 390 px и 1200×630 composition.
