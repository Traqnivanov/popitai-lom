...
assert(homeHtml.indexOf('Обяви и услуги')<homeHtml.indexOf('Последни обяви и услуги'));
assert(homeHtml.indexOf('Последни обяви и услуги')<homeHtml.indexOf('Инфо Лом'));
assert(homeHtml.indexOf('Инфо Лом')<homeHtml.indexOf('Местни фирми'));
assert(homeHtml.indexOf('Местни фирми')<homeHtml.indexOf('Полезни статии'));
assert(homeHtml.indexOf('Полезни статии')<homeHtml.indexOf('Не намери отговор? Попитай'));
