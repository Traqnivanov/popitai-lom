...
(() => {
  ...
  function iconCheckpoint(){
    ...
    return `<div class="page icon-system-page hybrid-icon-page">${pageHead('Хибридна icon система — един сравним checkpoint','Един и същ смисъл, но различна визуална тежест според реалната повърхност. Това не сменя иконите в сайта.')}<div class="shell">
      ...
      <section class="hybrid-desktop-proof" aria-labelledby="hybrid-desktop-title"><div class="section-head"><div><h2 id="hybrid-desktop-title">2. Site discovery · SVG + text-first</h2><p>Един силен family SVG знак. Конкретните услуги се четат като текст, а точният leaf знак също е лек SVG.</p></div></div><div class="hybrid-desktop-grid"><article class="hybrid-family-card"><div class="hybrid-family-head"><span class="hybrid-family-emblem" aria-hidden="true"><img src="icons/hammer-duotone.svg" width="64" height="64" alt=""></span><div><small>УСЛУГИ</small><h3>Майстори, ремонти и дом</h3><p>Избери точната услуга</p></div></div><nav class="hybrid-text-leaves" aria-label="Конкретни ремонтни услуги">${textLeaves}</nav></article><article class="hybrid-exact-card"><span class="hybrid-exact-label">ТОЧНА SVG ТЕМА · САМО ПРИ НУЖДА</span><div class="hybrid-exact-main"><span class="hybrid-exact-emblem" aria-hidden="true"><img src="icons/roofing-duotone.svg" width="64" height="64" alt=""></span><div><h3>Ремонт на покрив в Лом</h3><p>„Покриви“ не се представя с общ чук, но в сайта остава лек SVG.</p></div></div><a href="#results?context=Услуги&amp;group=Покриви&amp;owner=Listings&amp;detail=listing">Виж предложението ${chevron}</a></article></div></section>
      <section class="hybrid-mobile-proof" aria-labelledby="hybrid-mobile-title"><div class="section-head"><div><h2 id="hybrid-mobile-title">3. Реален mobile checkpoint · 390 px</h2><p>Family и exact leaf знаците са SVG; deep leaves остават text-first; action знаците са 20 px.</p></div></div><div class="hybrid-phone"><header><button type="button" aria-label="Назад">${actionIcon('m15 18-6-6 6-6')}</button><strong>Услуги</strong><button type="button" aria-label="Търси">${searchIcon}</button></header><div class="hybrid-phone-body"><div class="hybrid-phone-family"><span aria-hidden="true"><img src="icons/hammer-duotone.svg" width="56" height="56" alt=""></span><div><small>СЕМЕЙСТВО</small><strong>Майстори, ремонти и дом</strong></div></div><nav class="hybrid-phone-leaves" aria-label="Услуги на мобилен екран">${textLeaves}</nav><article class="hybrid-phone-result"><img src="icons/roofing-duotone.svg" width="56" height="56" alt=""><div><small>ТОЧНА SVG ТЕМА</small><strong>Ремонт на покрив</strong><span>Ясна при 56 px без 3D raster в сайта</span></div></article></div><nav class="hybrid-phone-nav" aria-label="Примерна мобилна навигация"><span>${searchIcon}<small>Търси</small></span><span>${addIcon}<small>Добави</small></span><span>${shareIcon}<small>Сподели</small></span></nav></div></section>
      ...
      <section class="hybrid-weight-proof" aria-labelledby="hybrid-weight-title"><div><h2 id="hybrid-weight-title">Тегло на този модел</h2><p>Deep-leaf списъкът добавя 0 изображения. Social asset не се зарежда в нормалния site list.</p></div><dl><div><dt>Family SVG</dt><dd>782 B</dd></div><div><dt>Exact site SVG</dt><dd>0.6 KB</dd></div><div><dt>Social WebP</dt><dd>20.9 KB</dd></div></dl></section>
      <div class="icon-system-decision"><strong>Предложение на Work 2</strong><p>Site/mobile използват само оптимизирани SVG за действия, family и необходимите exact leaves; deep leaves остават с текст. Одобреният подробен 3D asset се използва само в social/Facebook 1200×630 без собствена снимка. Правилото е: одобрена медия → точна leaf тема → family тема → Lom fallback, с отделен формат за site и social.</p></div>
    </div></div>`;
  }
