...
(() => {
  ...
  function iconCheckpoint(){
    const candidates=[
      ...
      {label:'Почистване на дом',file:'home-cleaning.webp',key:'home-cleaning',reason:'Прахосмукачка за домашно почистване',avoid:'да не се използва за офиси и входове без отделно решение'},
