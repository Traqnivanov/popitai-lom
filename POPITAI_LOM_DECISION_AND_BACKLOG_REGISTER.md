...
| Work 2 | 16.09.2026 | Dining reality/gap/duplicate audit е завършен read-only. Доказан е един силен кандидат (`Ресторант Дъгата`) и 4 research-only кандидата; inventory нараства от 7 на 12 records. Открит е OPEN production gate: хотел-ресторантите изискват един canonical Firms record с accommodation+dining discovery facets, защото текущият `businesses.category` е единичен text value. Няма runtime/schema/Supabase промяна. |
