...
| --- | --- | --- | --- | --- |
| Icon review scope | **PARTIALLY ACCEPTED — MASS EXPANSION PAUSED** | Work 1 → Work 2 · 10–15.09.2026 | Review branch съдържа исторически 128 px site WebP и 512 px social WebP варианти. Visual approval на конкретните 3D теми се пази само за social употреба; историческите site WebP варианти не разрешават site wiring. Това не разрешава production, Supabase или Stage 3. | Няма следваща масова серия. Един коригиран SVG-site/3D-social checkpoint следва преди owner verdict. |
| Strict site/social system | **APPROVED — REPLACES AMBIGUOUS 14.09 WORDING / COMPARISON PENDING** | Work 2 · 15.09.2026 · owner verdict `ок` след дословното правило | Site/mobile/navigation/family/exact leaf използват само оптимизирани SVG; deep leaves са text-first. Одобрените подробни 3D assets са само за social/Facebook 1200×630, когато няма одобрена собствена снимка. Няма 3D WebP/raster изключение в site категории, списъци, резултати или cards. | Коригиран desktop + 390 px SVG-site и отделен social 1200×630 checkpoint; после owner verdict. |
...
| --- | --- | --- | --- |
| Масова icon работа | **PAUSED AS CRITICAL PATH** | Петдневната icon работа създава schedule риск, смесен визуален език и слаба четимост при малки размери. Приетите 3D concepts не се губят и остават social-only. | Само коригираният SVG-site/3D-social comparison gate от §4A; без нова масова серия. |
...
4. Icon посоката получава един коригиран checkpoint: само оптимизиран SVG в site/mobile и отделен 3D social/Facebook 1200×630 пример; масовото leaf производство е спряно и не блокира Stage 2.
